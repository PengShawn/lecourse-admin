  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="eventList" border stripe ref="selectedList" >
        ...
        <el-table-column label="活动视频" prop="description">
          <template slot-scope="scope">
        ...
        <el-table-column label="操作" width="180px">
          <template slot-scope="scope">
            ...
            <!--删除按钮          -->
            <el-button type="danger" icon="el-icon-delete" size="mini" @click="removeEventById(scope.row.id)"></el-button>
            <!--审核视频按钮          -->
...
<script>
  ...
  import {fetchEventList} from "@/api/clubs";
  ...
  export default {
    ...
    methods: {
      //获取活动列表
      getEventList() {
        fetchEventList(this.queryInfo,clubId).then(res => {
